              ...
              <form action="" method="get">
                <div class="card-body">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('faculty/student_user/list')}}" class="btn btn-success" style="margin-top:24px;">Reset</a>
                    </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ url('faculty/student_user/edit/'.$value->id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        <a href="{{ url('faculty/student_user/list'.$value->id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>    
                    </tr>
