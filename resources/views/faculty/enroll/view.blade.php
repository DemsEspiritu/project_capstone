            ...
            <main class="content px-3 py-2">
                ...
                <div class="card-body">
                  <div class="form-group m-2">
                    <label>LRN</label>
                    <input type="text" name="lrn" value="{{ ($enroll->lrn) }}" required class="form-control">
                  </div>
                  <div class="form-group m-2">
                    <label>Name</label>
                    <input type="text" name="name" value="{{ ($enroll->name)  }} " required class="form-control">
                    <div style="color: red;">{{old('name') }} {{$errors->first('name')}} </div>
                  </div>
                  <div class="form-group m-2">
                    <label>Last Name</label>
                    <input type="text" name="last_name" value="{{ ($enroll->last_name)  }} " required class="form-control">
                    <div style="color: red;">{{old('name') }} {{$errors->first('name')}} </div>
                  </div>

                  <div class="form-group m-2">
                    <label>Middle Name</label>
                    <input type="text" name="middle_name" value="{{ ($enroll->middle_name)  }} " required class="form-control">
                    <div style="color: red;">{{old('middle_name') }} {{$errors->first('middle_name')}} </div>
                  </div>

                  <div class="form-group m-2">
                    <label>Email</label>
                    <input type="email" name="email" value="{{ ($enroll->email)  }} " required class="form-control"l">
                  ...
                  <div class="form-group m-2">
                    <label>address</label>
                    <input type="text" name="address" value="{{ ($enroll->address)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('address') }} {{$errors->first('address')}} </div>
                  </div>

                  <div class="form-group m-2">
                    <label>age</label>
                    <input type="text" name="age" value="{{ ($enroll->age)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('age') }} {{$errors->first('age')}} </div>
                  </div>

                  <div class="form-group m-2">
                    <label>gender</label>
                    <input type="text" name="gender" value="{{ ($enroll->gender)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('gender') }} {{$errors->first('gender')}} </div>
                  </div>


                  <div class="form-group m-2">
                    <label>phone_number</label>
                    <input type="text" name="phone_number" value="{{ ($enroll->phone_number)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('phone_number') }} {{$errors->first('phone_number')}} </div>
                  </div>


                  <div class="form-group m-2">
                    <label>place_bdate</label>
                    <input type="text" name="place_bdate" value="{{ ($enroll->place_bdate)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('place_bdate') }} {{$errors->first('place_bdate')}} </div>
                  </div>

                  <div class="form-group m-2">
                    <label>grade</label>
                    <input type="text" name="grade" value="{{ ($enroll->grade)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('grade') }} {{$errors->first('grade')}} </div>
                  </div>


                  <div class="form-group m-2">
                    <label>file</label>
                    <input type="text" name="file" value="{{ ($enroll->file)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('file') }} {{$errors->first('file')}} </div>
                    <a href="{{ url('faculty/enroll/fileview'.$enroll->id) }}" class="btn btn-danger m-2">View File</a>
                  </div>
                  ...
                  <label>Mother Name</label>
                    <input type="text" name="mother_name" value="{{ ($enroll->mother_name)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('mother_name') }} {{$errors->first('mother_name')}} </div>
                  </div>

                  <div class="form-group m-2">
                  <label>Mother Phone</label>
                    <input type="text" name="mother_phone" value="{{ ($enroll->mother_phone)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('mother_phone') }} {{$errors->first('mother_name')}} </div>
                  </div>


                  <div class="form-group m-2">
                  <label>Father Name</label>
                    <input type="text" name="father_name" value="{{ ($enroll->father_name)  }} " required class="form-control"l">
                    <div style="color: red;">{{old('father_phone') }} {{$errors->first('father_name')}} </div>
                  </div>
