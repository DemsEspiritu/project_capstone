            ...
            <main class="content px-3 py-2">
                ...
                <div class="container-fluid">
                  ...
                  @foreach($enrolls as $enroll)
                    <tr>
                      <td class="text-center">{{ $enroll->lrn}}</td>
                      <td class="text-center">{{ $enroll->name}}</td>
                      <td class="text-center">{{ $enroll->middle_name}}</td>
                      <td class="text-center">{{ $enroll->last_name}}</td>
                      <td class="text-center">{{ $enroll->gender}}</td>
                      <td class="text-center">{{ $enroll->email}}</td>
                      <td class="text-center">{{ $enroll->address}}</td>
                      <td class="text-center">{{ $enroll->age}}</td>
                      <td class="text-center">{{ $enroll->phone_number}}</td>
                      <td class="text-center">{{ $enroll->status}}</td>
