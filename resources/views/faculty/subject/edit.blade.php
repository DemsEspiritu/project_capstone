 ...
 <li class="sidebar-item">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="row">
                      <div class="col">
                          <input type="text" name="name" value="{{ ($subjects->name) }}" class="form-control" placeholder="Add New Subject">
                          <span style="color:red; font-size:10px;">@error('name'){{ $message}} @enderror</span>
                      </div>
                      <div class="col">
                          <input type="text" name="description" value="{{ ($subjects->description) }}"  class="form-control" placeholder="Description">
