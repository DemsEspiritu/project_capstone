 ...
 <li class="sidebar-item">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="row">
                      <div class="col">
                          <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Add New Subject">
                ...
                <div class="container-fluid">
                    ...
                    <tr>
                      ...
                      <th class="text-center"s>Description</th>
                    </tr>
                  </thead>
                  <tbody>
                  @foreach($subjectdata as $subject) 
                    <tr>
                      ...
                      <td class="text-center"> 
                        <a href="{{ url('faculty/subject/edit'.$subject->subject_id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        <a href="{{ url('faculty/subject/list'.$subject->subject_id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
