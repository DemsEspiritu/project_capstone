              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>Class 8 - Section 5</td>
                    <td>

                                         
                        <a  class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        
                    </td>
                    
                    
                  </tr>
                  @foreach($merge as $class)
                        
                  <label> {{$class->name ?? $class['name']}}</label>

                        @foreach ($classes as $room)
                        
                          @if(!empty($class['grade']) && str_contains($class['grade'], $room['name']))
