 ...
 <li class="sidebar-item">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="row">
                      <div class="col">
                          <input type="text" name="year_name" value="{{ old('year_name') }}" class="form-control" placeholder="Add New School Year (2023-2024)">
                ...
                <table class="table m-2 table-striped">
                  ...
                  @foreach($school_year as $year)
                    <tr>
                      <td class="text-center">{{$year->year_name}}</td>
                      <td class="text-center"> 
                        <a href="{{ url('faculty/school_year/edit'.$year->school_year_id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        <a href="{{ url('faculty/school_year/list'.$year->school_year_id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
