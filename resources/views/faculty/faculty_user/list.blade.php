      ...
      <div class="container-fluid">
          <div class="row">
            ...
            <div class="form-group col-md-3">
                   <a href="{{ url('faculty/faculty_user/add') }}" class="btn btn-primary"><i class="fa-solid fa-plus  p-1" style="color: #ffffff;"></i>Add New Admin</a>
            </div>
              ...
              <form action="" method="get">
                <div class="card-body">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('faculty/faculty_user/list')}}" class="btn btn-success" style="margin-top:24px;">Reset</a>
                    </div>
