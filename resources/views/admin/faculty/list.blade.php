      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <a href="/admin/faculty/list" class="nav-link px-3 active pt-3">
      ...
      <div class="container-fluid">
          <div class="row">
            ...
            <div class="form-group col-md-9">
              <h4>Faculty List (Total : {{ $data['getFaculty']->total() }} )</h4> 
            </div>
          
            <div class="form-group col-md-3">
                   <a href="{{ url('admin/faculty/add') }}" class="btn btn-primary"><i class="fa-solid fa-plus  p-1" style="color: #ffffff;"></i>Add New Faculty</a>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <h6 class="card-title">Search Faculty</h6>
              </div>
              <form action="" method="get">
                <div class="card-body">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/list')}}" class="btn btn-success" style="margin-top:24px;">Reset</a>
                    </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="{{ url('admin/faculty/edit/'.$value->id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                          <a href="{{ url('admin/faculty/list'.$value->id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>    
                    </tr>
