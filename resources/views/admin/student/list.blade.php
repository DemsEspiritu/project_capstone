        ...
        <div class="collapse navbar-collapse" id="topNavBar">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
              ...
              <span class="type_user">{{Auth::user()->name}}</span>
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <a href="/admin/student/list" class="nav-link active px-3 pt-3">
      ...
      <div class="container-fluid">
          <div class="row">
            ...
            <div class="form-group col-md-9">
              <h4>Student List  (Total : {{ $data['getStudent']->total() }} )</h4> 
            </div>
          
            <div class="form-group col-md-3">
            <a href="{{ url('admin/student/add') }}" class="btn btn-primary"><i class="fa-solid fa-plus  p-1" style="color: #ffffff;"></i>Add New Student</a>
            </div>
              ...
              <form action="" method="get">
                <div class="card-body">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/student/list')}}" class="btn btn-success" style="margin-top:24px;">Reset</a>
                    </div>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalEdit{{$value->id}}"><i class="fa-regular fa-eye p-1" style="color: #fafafa;"></i>View</a>
                        <a href="{{ url('admin/student/edit/'.$value->id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        <a href="{{ url('admin/student/list'.$value->id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>    
                    </tr>
                    @include('/admin/student/modal_view')
                    @endforeach
                  </tbody>
                </table>
                ...
                {!! $data['getStudent']->appends(Illuminate\Support\Facades\Request::except('page'))->links()!!}
                </div>
                <!-- End of pagination -->
              </div>
            </div>
