      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <a href="/admin/list" class="nav-link active px-3 pt-3">
      ...
      <div class="container-fluid">
          <div class="row">
            ...
            <div class="form-group col-md-9">
              <h4>Admin List  (Total : {{ $data['getRecord']->total() }} )</h4> 
            </div>
          
            <div class="form-group col-md-3">
              <a href="{{ url('admin/add') }}" class="btn btn-primary"><i class="fa-solid fa-plus  p-1" style="color: #ffffff;"></i>Add New Admin</a>
            </div>
      ...
      <div class="container-fluid mt-2">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Admin Table List</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="#" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalView{{$value->id}}"><i class="fa-regular fa-eye p-1" style="color: #fafafa;"></i>View</a>
                        <a href="{{ url('admin/edit/'.$value->id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit</a>
                        <a href="{{ url('admin/remove/'. $value->id) }}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                      </td>
                    </tr>
