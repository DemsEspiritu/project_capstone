...
<form action="" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade text-left" id="ModalAddClass" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        <div class="col-5">
                            <label>Class</label>
                          <select class="form-select" name="name" value="{{old('grade')}}">
                              <option></option>
                        ...
                        <div class="col-5">
                        <label>Section</label>
                          <select class="form-select" name="section" value="{{old('grade')}}">
                              <option></option>
