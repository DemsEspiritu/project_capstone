        ...
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <a href="#" class="nav-link px-3 pt-3">
              ...
              <a href="/admin/enroll" class="nav-link px-3  pt-3">
                <span class="me-2"><i class="fa-solid fa-people-line"></i></span>
                <span>Enroll Request</span></a>

                <hr>
                  <a href="/admin/enroll" class="nav-link active px-3  pt-3">
      ...
      <div class="container-fluid">
          <div class="row">
            ...
            <div class="form-group col-md-3">
              <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalAddClass""><i class="fa-solid fa-plus  p-1" style="color: #ffffff;"></i>Add New Class</a>
            </div>
            ...
            <div class="card-header">
              ...
              <form action="" method="get">
                <div class="card-body">
                    ...
                    <label>Class</label>
                          <select class="form-select" name="name" value="{{Request::get('name')}}">
                              <option></option>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/class/list')}}" class="btn btn-success" style="margin-top:24px;">Reset</a>
                    </div>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  @foreach($data['getRecord'] as $value)
                    <tr> 
                        ...
                        <td>
                        <a href="{{ url('admin/class/list'. $value->class_id)}}" class="btn btn-danger btn-sm"><i class="fa-regular fa-trash-can p-1" style="color: #fafafa;"></i>Delete</a>
                        <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#ModalEditClass{{$value->id}}"><i class="fa-regular fa-pen-to-square  p-1 style" color: #fafafa;"></i>Edit</a>
                ...
                @include('admin/class/modal_update')
