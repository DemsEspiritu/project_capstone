            ...
            <main class="content px-3 py-2">
                ...
                <div class="container-fluid"> <!--   this is form container fluid -->
                    ...
                    <hr>    
                            <div class="form-group col-md-2">
                                        <a href="{{ url('admin/student/add') }}" class="btn btn-sm btn-primary">Add New Record</a>
                            </div>
                    <hr>
                ...
                {{ csrf_field() }}
                  ...
                  <!-- foreach -->
                    ...
                    <td class="text-center"><input type="text" name="first_grading[]"></td>
                    <td class="text-center"><input type="text" name="second_grading[]"></td>
                    <td class="text-center"><input type="text" name="third_grading[]"></td>
                    <td class="text-center"><input type="text" name="fourth_grading[]"></td>
                    <td class="text-center"><input type="text" name="final_grades[]"></td>
